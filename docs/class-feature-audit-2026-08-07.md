...
- 固定分母 499；当前真实状态：`full 230 / partial 193 / dm_only 76`。
...
- 预兆/信实坐骑定向测试、Ruff、compileall、`git diff --check` 已通过；全量 pytest 将作为本检查点门禁继续运行。
...
- 运行时状态：`{'full': 230, 'dm_only': 76, 'partial': 193}`
