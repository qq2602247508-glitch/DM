...
当前审计为 `full 236 / partial 187 / dm_only 76`。本 Goal 从 `227/195/77` 开始，已完成预兆池、信实坐骑、高阶防守战术、钢铁意志、专业预言、战争祭司、意念守护和凶蛮打击的真实端到端闭环；领域 helper、配置覆盖数和单一分支不计入 full。
...
- 总条目：499
- 当前状态：`{'full': 236, 'dm_only': 76, 'partial': 187}`
