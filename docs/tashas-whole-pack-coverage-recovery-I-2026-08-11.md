...
- `item-ir-1` typed/reviewed：47/47；compile full：37；isolated runtime validated：37；registered production full：32；game usable：32；保留 DM 边界：10；name branch：0。
...
- Feature/Option reviewed：339；typed 85；compile 85；production 71；DM-assisted 1。该批次仍未达到 120/100/80/50/10 硬阈值，保持 partial，不虚报覆盖。
