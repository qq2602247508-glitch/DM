...
- `item-ir-1` typed/reviewed：47/47；compile full：40；isolated runtime validated：40；registered production full：40；game usable：40；保留 DM 边界：7；name branch：0。
...
- Feature/Option reviewed：340；typed 97；compile 97；production 96；DM-assisted 1。该批次仍未达到 120/100/80/50/10 硬阈值，保持 partial，不虚报覆盖。
...
- Authored provenance：106 total；orphan 0；2 条工具熟练别名已协调，Precision Attack 已按 build recommendation source 明确退役。
