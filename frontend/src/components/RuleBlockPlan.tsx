...
const BLOCK_STYLES: Record<RuleBlockKind, string> = {
  ...
  defense: "border-rose-800/60 bg-rose-950/20 text-rose-100",
  movement: "border-lime-800/60 bg-lime-950/20 text-lime-100",
  condition: "border-orange-800/60 bg-orange-950/20 text-orange-100",
  modifier: "border-indigo-800/60 bg-indigo-950/20 text-indigo-100",
  object_state: "border-yellow-800/60 bg-yellow-950/20 text-yellow-100",
  exploration_effect: "border-sky-800/60 bg-sky-950/20 text-sky-100",
