    ...
    contracts = [
        ...
        _contract(
            ...
            types={
                ...
                "common_spell_ids": "array",
                "selection_options": "object",
                "id": "string",
            },
            triggers=_TRIGGER_ADVANCEMENT,
            durations=_DURATION_PERSISTENT,
            materializer="advancement.spell_list_expansion",
            capability="advancement.spell_list_expansion",
        ),
        _contract(
            "prepare_spell",
        ...
        _contract(
            "teleport",
            required=("destination_kind", "roll_multiplier_ft"),
            optional=("roll_input", "roll_source", "id"),
            types={
                "destination_kind": "string",
                "roll_multiplier_ft": "integer",
                "roll_input": "string",
                "roll_source": "string",
                "id": "string",
            },
            enums={"destination_kind": {"visible_unoccupied_space"}},
            bounds={"roll_multiplier_ft": (1, 1000)},
            triggers=frozenset({"explicit_activation"}),
            actions=_ACTIONS_ANY,
            targets=_TARGET_SELF,
            durations=frozenset({"current_turn"}),
            resources=_RESOURCE_OPS,
            materializer="movement.teleport",
            capability="movement.teleport",
        ),
        _contract(
            "grant_sight_mode",
            required=("mode",),
        ...
        _contract(
            ...
            required=("entity_binding", "information_kind"),
            optional=(
                "range_ft",
                "visibility",
                "language_required",
            ...
            bounds={"range_ft": (1, 300)},
            triggers=frozenset({"explicit_activation", "action_resolved"}),
            actions=frozenset({"none"}),
            targets=_TARGET_SELF,
            durations=frozenset({"current_turn", "ten_minutes", "advancement_persistent"}),
            materializer="telepathic.information",
            capability="communication.telepathic_information",
        ),
        _contract(
            "configure_entity_spatial",
            required=("entity_binding", "max_move_ft", "expiry_distance_ft"),
            optional=(
                "cell_size_ft",
            ...
            types={
                "entity_binding": "string",
                "max_move_ft": "integer",
                "expiry_distance_ft": "integer",
                "cell_size_ft": "integer",
                "requires_owner_visibility": "boolean",
                "requires_unoccupied_destination": "boolean",
                "cannot_cross_objects": "boolean",
                "id": "string",
            },
            enums={"entity_binding": {"entity_lifecycle"}},
            bounds={
                "max_move_ft": (1, 30),
                "expiry_distance_ft": (1, 300),
                "cell_size_ft": (1, 10),
            },
            triggers=frozenset({"explicit_activation", "advancement_confirmed"}),
            actions=frozenset({"bonus_action", "none"}),
            targets=_TARGET_SELF,
            durations=frozenset({"ten_minutes", "advancement_persistent"}),
            materializer="entity.spatial",
            capability="entity.spatial",
        ),
        _contract(
            "heal",
        ...
        _contract(
            ...
            optional=("required_condition", "range_ft", "id"),
            types={
                "channel": "string",
                "direction": "string",
            ...
            triggers=_TRIGGER_ADVANCEMENT,
            actions=_ACTIONS_NONE,
            targets=frozenset({"one_creature"}),
            durations=_DURATION_PERSISTENT,
            materializer="communication.channel",
            capability="communication.mutual_comprehension",
        ),
        _contract(
            ...
            types={
                ...
                "initial_placement": "object",
                "id": "string",
            },
            enums={"source_binding": {"feature_source"}},
            bounds={"max_entries": (1, 10000)},
            triggers=_TRIGGER_ADVANCEMENT,
            actions=_ACTIONS_NONE,
            targets=_TARGET_SELF,
            durations=_DURATION_PERSISTENT,
            materializer="entity.lifecycle",
            capability="entity.lifecycle",
        ),
        _contract(
            "configure_vessel_space",
            required=("vessel_binding", "max_occupants"),
            optional=(
                "duration_hours",
            ...
            types={
                "vessel_binding": "string",
                "max_occupants": "integer",
                "duration_hours": "integer",
                "duration_hours_source": "string",
                "appearance_options": "array",
                "exit_size_cells": "integer",
                "id": "string",
            },
            enums={
            ...
            materializer="vessel.space",
            capability="vessel.space",
        ),
        _contract(
            "configure_remote_spell_origin",
            required=("origin_kind", "origin_binding", "target_kind"),
            optional=("max_range_ft", "require_line_of_effect", "id"),
            types={
                "origin_kind": "string",
                "origin_binding": "string",
                "target_kind": "string",
                "max_range_ft": "integer",
                "require_line_of_effect": "boolean",
                "id": "string",
            },
            enums={
                "origin_kind": {"entity"},
                "origin_binding": {"entity_lifecycle"},
                "target_kind": {"one_creature", "multiple_creatures"},
            },
            bounds={"max_range_ft": (0, 10000)},
            triggers=frozenset({"spell_cast", "explicit_activation"}),
            actions=frozenset(
