...
def default_capability_catalog() -> CapabilityCatalog:
    ...
    closed: list[CapabilityDescriptor] = [
        ...
        _descriptor(
            ...
            consumer="authorized_target_information_projection",
            producer="inspection_action",
            persisted_state="combat_action.audit",
            status="production_partial",
            limitations=("目标信息读取消费者尚未完成全量安全证明。",),
            evidence=("target_information_partial_contract",),
        ),
        _descriptor(
            "spell.context",
