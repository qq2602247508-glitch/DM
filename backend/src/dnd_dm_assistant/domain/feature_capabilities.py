...
def default_capability_catalog() -> CapabilityCatalog:
    ...
    closed: list[CapabilityDescriptor] = [
        ...
        _descriptor(
            ...
            evidence=(
                "test_vessel_space_runtime_contract",
                "test_content_ir_vessel_runtime",
                "test_migrations",
        ...
        _descriptor(
            "communication.telepathic_information",
            "share_authorized_sensory_information",
            consumer="content_ir_runtime.telepathic_information",
            producer="feature_runtime_compiler",
            persisted_state="combat_action.result_json",
            targets=frozenset({"self"}),
            ...
            status="production_closed",
            evidence=("test_content_ir_telepathic_information_runtime",),
        ),
        _descriptor(
            "entity.spatial",
            "configure_entity_spatial",
            consumer="content_ir_runtime.entity_spatial",
            producer="feature_runtime_compiler",
            persisted_state="combatant.snapshot_json.feature_runtime.entity_spatial",
            targets=frozenset({"self"}),
            durations=frozenset({"ten_minutes", "advancement_persistent"}),
            actions=frozenset({"bonus_action", "none"}),
            status="production_closed",
            evidence=("test_content_ir_entity_spatial_runtime",),
        ),
        _descriptor(
            "spell.remote_origin",
