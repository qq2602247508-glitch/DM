...
REPORT = ROOT / "reports/tashas-feature-production-consumer-round-V-2026-08-12.json"
RESULTS = ROOT / "data/content-ir/compiled/production-runtime-results-VII.json"


def test_round_V_advancement_consumer_has_real_character_growth_evidence() -> None:
    ...
    assert report["checks"]["choice_lifecycle_consumers"] == 3
