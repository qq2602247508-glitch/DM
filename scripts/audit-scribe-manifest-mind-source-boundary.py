    ...
    *,
    ...
    return [
        ...
        row(
            ...
            source_paths=(
                "backend/src/dnd_dm_assistant/domain/telepathic_information.py",
                "backend/tests/test_content_ir_telepathic_information_runtime.py",
            ),
            source_needles=("无需动作",),
            blocker="Telepathic sharing requires a source-bound owner-only/no-action receipt over active authorized entity senses.",
            evidence=("telepathic preview/confirm/replay receipt",),
            cas_replay=True,
        ),
        row(
            "remote-spell-origin",
        ...
        row(
            ...
            blocker="Spatial movement requires an authored feature-bound bonus-action receipt, not only a generic spatial seam.",
            evidence=("entity.spatial preview/confirm/replay receipt",),
            source_provenance=True,
        ),
        row(
            "distance-expiry",
            ...
            blocker="Distance expiry requires the authored entity.spatial binding and a real runtime receipt.",
            evidence=("entity.spatial expiry CAS/replay receipt",),
            source_provenance=True,
        ),
        *[
            row(
